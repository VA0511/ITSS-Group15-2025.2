...
SELECT tb.member_id, ts.facility_id, ts.session_time, ts.booking_id
FROM "TrainingSession" ts
JOIN "TrainingBooking" tb ON ts.booking_id = tb.id
WHERE ts.attendance_status = 'Present';

-- Insert some free check-ins
INSERT INTO "CheckInHistory" ("member_id", "facility_id", "check_in_time", "booking_id") VALUES
(1, 1, '2026-05-06 17:00:00', NULL),
(2, 2, '2026-05-15 18:30:00', NULL);
